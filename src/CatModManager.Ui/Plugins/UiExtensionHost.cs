...
public class UiExtensionHost : IPluginRegistrar
{
    ...
    private readonly List<IModContextAction>  _modContextActions = new();
    ...
    public IReadOnlyList<IModContextAction>  ModContextActions  => _modContextActions;
    ...
    public void RegisterModContextAction(IModContextAction action) => _modContextActions.Add(action);
